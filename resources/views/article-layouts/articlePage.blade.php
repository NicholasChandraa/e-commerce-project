...
<body class="bg-white">
        ...
        <div class="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center">
            <div class="flex items-center space-x-4 mb-4 md:mb-0 mr-3">
                ...
                <form method="GET" action="{{ url('/home') }}" class="flex items-center relative">
                    ...
                    <button type="submit"
                        class="bg-purple-600 text-white h-[42px] p-2 rounded-r hover:bg-purple-700 transition duration-200">Search</button>
                </form>
            </div>
            <nav class="flex space-x-4 items-center">
                <a href="{{ route('main') }}" class="text-gray-700 hover:text-purple-500">Home</a>
                <a href="{{ route('home') }}" class="text-gray-700 hover:text-purple-500">Shop</a>
                <a href="/about" class="text-gray-700 hover:text-purple-500">About</a>
                <a href="/articlePages" class="text-gray-700 hover:text-purple-500 text-center">Articles</a>
    ...
    <!-- Profile -->
    <div class="md:flex md:justify-end absolute top-[110px] md:top-[78px] right-0" style="z-index: 100;">
        <div id="menu" class="hidden md:w-full bg-white shadow-md py-3 sm:p-4 mb-4 space-y-4 relative">
            <ul>
                ...
                @if (Auth::user()->role === 'admin')
                    ...
                    <li><a href="{{ route('manageArticles') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-purple-50">Manage Articles</a></li>
                @endif
                <li>
                    <form action="{{ route('logout') }}" method="POST" class="block">
                        @csrf
                        <button type="submit"
                            class="w-full text-left px-4 py-2 text-gray-700 hover:bg-purple-50">Logout</button>
                    </form>
                </li>
            </ul>
        </div>
