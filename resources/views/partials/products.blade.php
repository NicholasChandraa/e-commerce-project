@foreach ($products as $product)
    <div class="bg-white p-4 rounded-lg shadow-md flex flex-col">
        ...
        <h3 class="text-lg font-bold line-clamp-2">{{ $product->name }}</h3>
        ...
        <div class="mt-auto">
            ...
            <a href="{{ route('products.show', $product->id) }}" class="text-purple-500 hover:text-purple-800">Detail
                Produk</a>
            <form id="add-to-cart-form-{{ $product->id }}" class="grid grid-2 gap-4 mt-4 bg-white add-to-cart-form"
