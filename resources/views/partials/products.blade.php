    ...
    <div class="mt-auto">
        ...
        <form id="add-to-cart-form-{{ $product->id }}" class="grid grid-2 gap-4 mt-4 bg-white add-to-cart-form" data-product-id="{{ $product->id }}">
            ...
            <div class="flex items-center space-x-2">
                ...
                <input type="number" id="quantity-{{ $product->id }}" name="quantity" value="1" min="1" class="w-full text-end p-2 border rounded-md focus:ring-purple-500 focus:border-purple-500">
            </div>
